package com.pokemonurpg.configuration.v1.member.member.repository;
...
public class MemberRepositoryFake implements MemberRepository {
    public final static String DISCORD_ID_FOR_EXISTING_MEMBER = "DISCORD_ID_FOR_EXISTING_MEMBER";
    public final static String NAME_FOR_EXISTING_MEMBER = "NAME_FOR_EXISTING_MEMBER";

    public Member findByDiscordId(String discordId) {
        if (DISCORD_ID_FOR_EXISTING_MEMBER.equals(discordId)) {
            return new Member();
        }
        else {
            return null;
    ...
    public Member findByName(String name) {
        if (NAME_FOR_EXISTING_MEMBER.equals(name)) {
            return new Member();
        }
        else {
            return null;
    ...
    @Override
    public Member findFirstByNameStartingWith(String name) {
