...
public class KnownGymLeaderServiceTest {
    ...
    private final static KnownGymLeader MODEL = new KnownGymLeader();

    @InjectMocks
    private KnownGymLeaderService service;

    @Mock
    private KnownGymLeaderRepository repository;
    ...
    public void test_constructor() {
        ...
        assertEquals(KnownGymLeader.class, service.getModelClass());
    }
    ...
    public void test_createForNameIfUnique_WhenUnique() {
        ...
        KnownGymLeader model = captor.getValue();
        assertEquals(NEW_NAME, model.getName());
    }
