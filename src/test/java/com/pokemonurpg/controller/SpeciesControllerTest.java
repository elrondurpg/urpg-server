...
public class SpeciesControllerTest
{
    ...
    public void getSpeciesByNameTest() {
        ...
        assertEquals(speciesName, responseWithFullName.getBody().getLabel());
        ...
        assertEquals(speciesName, responseWithPartialName.getBody().getLabel());
