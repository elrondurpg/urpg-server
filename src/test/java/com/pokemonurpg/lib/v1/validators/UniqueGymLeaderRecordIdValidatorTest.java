...
public class UniqueGymLeaderRecordIdValidatorTest {
    ...
    @InjectMocks
    private UniqueGymLeaderRecordIdValidator validator;
    ...
    public void isValid_ReturnsFalse_WhenIdIsNotUnique() {
        when(gymLeaderRecordService.findByGymAndOwnerAndOpenDate(GYM_NAME, OWNER_NAME, OPEN_DATE)).thenReturn(new GymLeaderRecord());
    ...
    public void isValid_ReturnsTrue_WhenIdIsUnique() {
        when(gymLeaderRecordService.findByGymAndOwnerAndOpenDate(GYM_NAME, OWNER_NAME, OPEN_DATE)).thenReturn(null);
        GymLeaderRecordRequest input = new GymLeaderRecordRequest();
        input.setGym(GYM_NAME);
        input.setOwner(OWNER_NAME);
        input.setOpenDate(OPEN_DATE);
