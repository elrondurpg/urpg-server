...
public class RequestHeaderServiceTest {
    ...
    private final static String KNOWN_HEADER_NAME = "KNOWN_HEADER_NAME";
    private final static String UNKNOWN_HEADER_NAME = "UNKNOWN_HEADER_NAME";
    ...
    private HttpServletRequest request = new HttpServletRequest() {
        ...
        public String getHeader(String s) {
            if (KNOWN_HEADER_NAME.equals(s)) return HEADER;
            else return null;
        }
    ...
    public void findByName() {
        assertEquals(HEADER, requestHeaderService.findByName(KNOWN_HEADER_NAME));
    }
