...
import com.pokemonurpg.configuration.v3.pokemon.species.shared.view.GetSpeciesAttackView;
...
@Setter
@Table(name = "attack")
public class AttackEntity extends NamedEntity implements GetSpeciesAttackView {
