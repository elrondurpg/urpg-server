...
public class ChampionRecord {
    ...
    public ChampionRecord(ChampionRecordRequest input) {
        this.update(input);
        setOpenDate(input.getOpenDate());
    }

    public void update(ChampionRecordRequest input) {
    ...
    public ChampionSlot getSlot() {
        return slot;
    }

    public void setSlot(ChampionSlot slot) {
        this.slot = slot;
    }
