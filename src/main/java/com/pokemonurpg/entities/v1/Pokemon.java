...
@Entity
@Table(name = "species")
public class Pokemon implements NamedObject {
    ...
    public Pokemon(PokemonRequest input) {
        this.update(input);
    ...
    public void update(PokemonRequest input) {
    ...
    public Pokemon getPreMega() {
        return preMega;
    }

    public void setPreMega(Pokemon preMega) {
        if (preMega != null) {
    ...
    public void setAttacks(List<PokemonAttack> attacks) {
