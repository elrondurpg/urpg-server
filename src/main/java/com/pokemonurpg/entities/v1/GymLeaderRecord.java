...
@Table(name = "gym_ownership_term")
public class GymLeaderRecord implements IndexedObject {
    ...
    public GymLeaderRecord() {}

    public GymLeaderRecord(GymLeaderRecordRequest input) {
        this.update(input);
        setOpenDate(input.getOpenDate());
    }

    public void update(GymLeaderRecordRequest input) {
