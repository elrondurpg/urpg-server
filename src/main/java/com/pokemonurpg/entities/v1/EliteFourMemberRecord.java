...
@Table(name = "elite_four_ownership_term")
public class EliteFourMemberRecord {
    ...
    private EliteFourMemberSlot slot;
    ...
    public EliteFourMemberRecord() {}

    public EliteFourMemberRecord(EliteFourRecordRequest input) {
        this.update(input);
        setOpenDate(input.getOpenDate());
    }

    public void update(EliteFourRecordRequest input) {
    ...
    public EliteFourMemberSlot getSlot() {
        return slot;
    }

    public void setSlot(EliteFourMemberSlot slot) {
        this.slot = slot;
    }
