...
public class OwnedPokemonRequest {
    ...
    protected List<@Valid OwnedExtraMoveRequest> ownedExtraMoves = new ArrayList<>();

    protected List<@Valid OwnedHiddenAbilityRequest> ownedHiddenAbilities = new ArrayList<>();

    protected List<@Valid EarnedRibbonRequest> earnedRibbons = new ArrayList<>();
    ...
    protected Set<@Valid WishlistAbilityRequest> wishlistAbilities = new HashSet<>();

    protected Set<@Valid WishlistMoveRequest> wishlistMoves = new HashSet<>();
    ...
    public List<OwnedExtraMoveRequest> getOwnedExtraMoves() {
        return ownedExtraMoves;
    }

    public void setOwnedExtraMoves(List<OwnedExtraMoveRequest> ownedExtraMoves) {
        this.ownedExtraMoves = ownedExtraMoves;
    }

    public List<OwnedHiddenAbilityRequest> getOwnedHiddenAbilities() {
        return ownedHiddenAbilities;
    }

    public void setOwnedHiddenAbilities(List<OwnedHiddenAbilityRequest> ownedHiddenAbilities) {
        this.ownedHiddenAbilities = ownedHiddenAbilities;
    }

    public List<EarnedRibbonRequest> getEarnedRibbons() {
        return earnedRibbons;
    }

    public void setEarnedRibbons(List<EarnedRibbonRequest> earnedRibbons) {
    ...
    public Set<WishlistAbilityRequest> getWishlistAbilities() {
        return wishlistAbilities;
    }

    public void setWishlistAbilities(Set<WishlistAbilityRequest> wishlistAbilities) {
        this.wishlistAbilities = wishlistAbilities;
    }

    public Set<WishlistMoveRequest> getWishlistMoves() {
        return wishlistMoves;
    }

    public void setWishlistMoves(Set<WishlistMoveRequest> wishlistMoves) {
