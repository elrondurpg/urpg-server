...
public abstract class RegisterPlayerController<Request extends RegisterPlayerRequest, Response extends RegisterPlayerResponse> {

    @Resource
    private RegisterPlayerHandler<Request, Response, ?, ?> handler;
    ...
    @PostMapping
    public @ResponseBody
    Response register(@Valid @RequestBody Request input) {
