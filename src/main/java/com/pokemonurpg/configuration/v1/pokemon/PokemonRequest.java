...
@UniqueName(type = Pokemon.class)
public class PokemonRequest implements UniquelyNamedRequest {
    ...
    private List<@Valid PokemonAttackRequest> attacks = new ArrayList<>();

    private List<@Valid PokemonAbilityRequest> abilities = new ArrayList<>();

    private List<@Valid CosmeticFormRequest> cosmeticForms = new ArrayList<>();
    ...
    public List<PokemonAttackRequest> getAttacks() {
        if (attacks == null) return Collections.emptyList();
        else return attacks;
    }

    public void setAttacks(List<PokemonAttackRequest> attacks) {
        this.attacks = attacks;
    }

    public List<PokemonAbilityRequest> getAbilities() {
        if (abilities == null) return Collections.emptyList();
        else return abilities;
    }

    public void setAbilities(List<PokemonAbilityRequest> abilities) {
        this.abilities = abilities;
    }

    public List<CosmeticFormRequest> getCosmeticForms() {
        if (cosmeticForms == null) return Collections.emptyList();
        else return cosmeticForms;
    }

    public void setCosmeticForms(List<CosmeticFormRequest> cosmeticForms) {
