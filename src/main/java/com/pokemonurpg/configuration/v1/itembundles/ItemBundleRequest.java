...
public class ItemBundleRequest implements UniquelyNamedRequest {
    ...
    private List<@Valid ItemBundleItemRequest> items = new ArrayList<>();
    ...
    public List<ItemBundleItemRequest> getItems() {
        return items;
    }

    public void setItems(List<ItemBundleItemRequest> items) {
        this.items = items;
    }
}