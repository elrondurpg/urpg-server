...
public class GymRequest {
    ...
    private List<@Valid GymPokemonRequest> pokemon = new ArrayList<>();
    ...
    public List<GymPokemonRequest> getPokemon() {
        return pokemon;
    }

    public void setPokemon(List<GymPokemonRequest> pokemon) {
