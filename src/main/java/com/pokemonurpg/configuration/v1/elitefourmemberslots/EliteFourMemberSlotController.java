...
@RestController
@RequestMapping("/urpg-configuration/v1/elite-four-member-slots")
@CrossOrigin
@Validated
public class EliteFourMemberSlotController {
    ...
    public @ResponseBody
    List<String> findAll() {
        return eliteFourMemberSlotService.findAllNames();
    }
    ...
    public @ResponseBody
    EliteFourMemberSlot findByName(@PathVariable("name") String name) {
        return eliteFourMemberSlotService.findByName(name);
    }
    ...
    @JsonView(value = { View.MemberView.Summary.class })
    public @ResponseBody
    EliteFourMemberSlot create(@Valid @RequestBody EliteFourMemberSlotRequest input) {
        return eliteFourMemberSlotService.create(input);
    }
    ...
    @JsonView(value = { View.MemberView.Summary.class })
    public @ResponseBody
    EliteFourMemberSlot update(@Valid @RequestBody EliteFourMemberSlotRequest input, @PathVariable int dbid) {
        return eliteFourMemberSlotService.update(input, dbid);
    }
